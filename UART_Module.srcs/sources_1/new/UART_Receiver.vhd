...
begin
  ...
  BRDESER: Buffer_Register_Deserializer port map(clk, rst, data_intern, data_ready_intern, parallel_out, new_data);
  DESER: Deserializer port map(prescaled_clk_intern, rst, serial_in, data_intern, data_ready_intern);
